        ...
        if Base.metadata.tables:
            ...
            try:
                ...
                startup_migrations = [
                    ...
                    # issuance_requests schema synchronization
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS third_party_cr VARCHAR",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS third_party_name VARCHAR",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS third_party_address VARCHAR",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS third_party_relationship VARCHAR",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS is_third_party BOOLEAN DEFAULT FALSE",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS beneficiary_id_number VARCHAR",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS payable_currency_id INTEGER",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS operational_status VARCHAR",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS lg_language VARCHAR DEFAULT 'AR'",
                    ...
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS is_cross_border BOOLEAN DEFAULT FALSE",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS issuance_country VARCHAR",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS requires_special_wording BOOLEAN DEFAULT FALSE",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS is_urgent BOOLEAN DEFAULT FALSE",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS urgency_justification TEXT",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS other_conditions TEXT",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS comments TEXT",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS custom_field_1_value VARCHAR",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS custom_field_2_value VARCHAR",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS current_version_number INTEGER DEFAULT 1",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS locked_for_issuance BOOLEAN DEFAULT FALSE",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS current_approval_step INTEGER DEFAULT 0",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS pending_approver_role VARCHAR",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS pending_approver_users JSONB",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS signatures_collected INTEGER DEFAULT 0",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS approval_chain_audit JSONB",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS revision_notes TEXT",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS returned_from_step INTEGER",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS selected_sub_limit_id INTEGER",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS applicable_rules VARCHAR",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS cross_border_details JSONB",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS treasury_enrichment JSONB",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS lg_record_id INTEGER",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS cancellation_reason TEXT",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS metadata_json JSONB DEFAULT '{}'::jsonb",
                    "ALTER TABLE issuance_requests ADD COLUMN IF NOT EXISTS project_id INTEGER",

                    # issued_lg_records schema synchronization
                    "ALTER TABLE issued_lg_records ADD COLUMN IF NOT EXISTS internal_serial VARCHAR",
                    "ALTER TABLE issued_lg_records ADD COLUMN IF NOT EXISTS facility_sub_limit_id INTEGER",
                    "ALTER TABLE issued_lg_records ADD COLUMN IF NOT EXISTS request_id INTEGER",
                    "ALTER TABLE issued_lg_records ADD COLUMN IF NOT EXISTS bank_id INTEGER",
                    "ALTER TABLE issued_lg_records ADD COLUMN IF NOT EXISTS issuance_method VARCHAR",
                    ...
                    "ALTER TABLE issued_lg_records ADD COLUMN IF NOT EXISTS bank_inquiry_log JSONB DEFAULT '[]'::jsonb",
                    ...
                    "ALTER TABLE issued_lg_records ADD COLUMN IF NOT EXISTS verified_by_user_id INTEGER",
                    "ALTER TABLE issued_lg_records ADD COLUMN IF NOT EXISTS verified_at TIMESTAMP WITH TIME ZONE",
                    "ALTER TABLE issued_lg_records ADD COLUMN IF NOT EXISTS handover_date DATE",
                    "ALTER TABLE issued_lg_records ADD COLUMN IF NOT EXISTS handover_notes TEXT",
                    "ALTER TABLE issued_lg_records ADD COLUMN IF NOT EXISTS handover_by_user_id INTEGER",
                    "ALTER TABLE issued_lg_records ADD COLUMN IF NOT EXISTS recipient_name VARCHAR",
                    "ALTER TABLE issued_lg_records ADD COLUMN IF NOT EXISTS recipient_email VARCHAR",
                    "ALTER TABLE issued_lg_records ADD COLUMN IF NOT EXISTS recipient_department VARCHAR",
                    "ALTER TABLE issued_lg_records ADD COLUMN IF NOT EXISTS recipient_job_title VARCHAR",
                    "ALTER TABLE issued_lg_records ADD COLUMN IF NOT EXISTS recipient_phone VARCHAR",
                    "ALTER TABLE issued_lg_records ADD COLUMN IF NOT EXISTS recipient_employee_id VARCHAR",
                    "ALTER TABLE issued_lg_records ADD COLUMN IF NOT EXISTS recipient_manager_email VARCHAR",
                    "ALTER TABLE issued_lg_records ADD COLUMN IF NOT EXISTS recipient_second_line_manager_email VARCHAR",
                    "ALTER TABLE issued_lg_records ADD COLUMN IF NOT EXISTS handover_signed_copy_path VARCHAR",
                    "ALTER TABLE issued_lg_records ADD COLUMN IF NOT EXISTS custody_transfer_log JSONB DEFAULT '[]'::jsonb",
                    "ALTER TABLE issued_lg_records ADD COLUMN IF NOT EXISTS cancellation_notice JSONB",
                    "ALTER TABLE issued_lg_records ADD COLUMN IF NOT EXISTS cancellation_letter_path VARCHAR",

                    # issuance_facility_sub_limits schema synchronization
                    "ALTER TABLE issuance_facility_sub_limits ADD COLUMN IF NOT EXISTS dedicated_project_ids JSONB",
