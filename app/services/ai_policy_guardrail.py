...
APPROVED_OPERATIONS: Dict[str, Dict[str, Any]] = {
    ...
    "search_lgs": {"params": {"query": str, "currency": str, "bank": str, "status": str, "search_term": str, "sort_by": str, "limit": int, "min_amount": (int, float), "max_amount": (int, float)}},
    "get_lg_details": {"params": {"lg_id": int, "lg_number": str}},
    "get_audit_history": {"params": {"scope": str, "limit": int, "search_term": str}},
