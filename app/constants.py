...
class GlobalConfigKey(str, Enum):
    ...
    DOC_MANDATORY_RELEASE = "DOC_MANDATORY_RELEASE"
    DOC_MANDATORY_LIQUIDATION = "DOC_MANDATORY_LIQUIDATION"
    DOC_MANDATORY_DECREASE_AMOUNT = "DOC_MANDATORY_DECREASE_AMOUNT"
    DOC_MANDATORY_ACTIVATE = "DOC_MANDATORY_ACTIVATE"
    DOC_MANDATORY_RECORD_DELIVERY = "DOC_MANDATORY_RECORD_DELIVERY"
    DOC_MANDATORY_RECORD_BANK_REPLY = "DOC_MANDATORY_RECORD_BANK_REPLY"
    DOC_MANDATORY_LG_HANDOVER = "DOC_MANDATORY_LG_HANDOVER"
    DOC_MANDATORY_ISSUED_LG_SCAN = "DOC_MANDATORY_ISSUED_LG_SCAN"
    ISSUED_LG_VERIFICATION_POLICY = "ISSUED_LG_VERIFICATION_POLICY"
    QUOTATION_APPROVAL_REQUIRED = "QUOTATION_APPROVAL_REQUIRED"
    QUOTATION_VALUE_DATE_INTEREST_MARGIN = "QUOTATION_VALUE_DATE_INTEREST_MARGIN"
    QUOTATION_CANCELLATION_CUTOFF_MINUTES = "QUOTATION_CANCELLATION_CUTOFF_MINUTES"
    QUOTATION_ACCEPTANCE_TIMEOUT_FX_SPOT = "QUOTATION_ACCEPTANCE_TIMEOUT_FX_SPOT"
    QUOTATION_ACCEPTANCE_TIMEOUT_TBILL = "QUOTATION_ACCEPTANCE_TIMEOUT_TBILL"
    QUOTATION_ACCEPTANCE_DEFAULT_ACTION = "QUOTATION_ACCEPTANCE_DEFAULT_ACTION"
    ALLOW_CROSS_ENTITY_INDICATIVE_QUOTES = "ALLOW_CROSS_ENTITY_INDICATIVE_QUOTES"
    CBE_OVERNIGHT_LENDING_RATE = "CBE_OVERNIGHT_LENDING_RATE"
    CBE_OVERNIGHT_DEPOSIT_RATE = "CBE_OVERNIGHT_DEPOSIT_RATE"
    CBE_MID_CORRIDOR_RATE = "CBE_MID_CORRIDOR_RATE"
    # Issuance LG Expiry Reminders (A1)
    ISSUANCE_LG_EXPIRY_FIRST_REMINDER_DAYS = "ISSUANCE_LG_EXPIRY_FIRST_REMINDER_DAYS"
    ISSUANCE_LG_EXPIRY_SECOND_REMINDER_DAYS = "ISSUANCE_LG_EXPIRY_SECOND_REMINDER_DAYS"
    ISSUANCE_LG_EXPIRY_REMINDER_INTERVAL = "ISSUANCE_LG_EXPIRY_REMINDER_INTERVAL"
    # Reference Expiry Tracking (A3)
    REFERENCE_EXPIRY_REMINDER_DAYS = "REFERENCE_EXPIRY_REMINDER_DAYS"
    # Facility Utilization Alerts (A7)
    FACILITY_UTILIZATION_ALERT_THRESHOLD_80 = "FACILITY_UTILIZATION_ALERT_THRESHOLD_80"
    FACILITY_UTILIZATION_ALERT_THRESHOLD_90 = "FACILITY_UTILIZATION_ALERT_THRESHOLD_90"
    FACILITY_UTILIZATION_ALERT_THRESHOLD_100 = "FACILITY_UTILIZATION_ALERT_THRESHOLD_100"
    ...
    FACILITY_SCORE_WEIGHT_COST = "FACILITY_SCORE_WEIGHT_COST"
    FACILITY_SCORE_WEIGHT_MARGIN = "FACILITY_SCORE_WEIGHT_MARGIN"
    FACILITY_SCORE_WEIGHT_SLA = "FACILITY_SCORE_WEIGHT_SLA"
    FACILITY_SCORE_WEIGHT_CAPACITY = "FACILITY_SCORE_WEIGHT_CAPACITY"
    FACILITY_SCORE_WEIGHT_CURRENCY_MATCH = "FACILITY_SCORE_WEIGHT_CURRENCY_MATCH"
    # C3: Facility Scoring Weights — Urgent Requests
    FACILITY_SCORE_WEIGHT_URGENT_COST = "FACILITY_SCORE_WEIGHT_URGENT_COST"
    FACILITY_SCORE_WEIGHT_URGENT_MARGIN = "FACILITY_SCORE_WEIGHT_URGENT_MARGIN"
    FACILITY_SCORE_WEIGHT_URGENT_SLA = "FACILITY_SCORE_WEIGHT_URGENT_SLA"
    FACILITY_SCORE_WEIGHT_URGENT_CAPACITY = "FACILITY_SCORE_WEIGHT_URGENT_CAPACITY"
    FACILITY_SCORE_WEIGHT_URGENT_CURRENCY_MATCH = "FACILITY_SCORE_WEIGHT_URGENT_CURRENCY_MATCH"
    # C5: FX Rate Drift Warning threshold (percentage)
    ...
    INBOX_POLL_INTERVAL_MINUTES = "INBOX_POLL_INTERVAL_MINUTES"
    INBOX_DEFAULT_POSITION_REQUEST_DAY = "INBOX_DEFAULT_POSITION_REQUEST_DAY"
    INBOX_RETENTION_MONTHS = "INBOX_RETENTION_MONTHS"
    INBOX_GENERIC_DOMAIN_BLACKLIST = "INBOX_GENERIC_DOMAIN_BLACKLIST"
...
ACTION_TYPE_LG_CANCEL_LIQUIDATION = "CANCEL_LIQUIDATION"
...
ACTION_TYPES_REQUIRING_APPROVAL = [
    ...
    ACTION_TYPE_LG_CANCEL_LIQUIDATION
]
...
AUDIT_ACTION_TYPE_AI_AMEND_SCAN_SUCCESS = "AI_AMEND_SCAN_SUCCESS"
AUDIT_ACTION_TYPE_AI_AMEND_SCAN_FAILED = "AI_AMEND_SCAN_FAILED"
...
AUDIT_ACTION_TYPE_LG_RENEWAL_DIGEST_SENT = "LG_RENEWAL_DIGEST_SENT"
AUDIT_ACTION_TYPE_LG_OWNER_RENEWAL_DIGEST_SENT = "LG_OWNER_RENEWAL_DIGEST_SENT"
AUDIT_ACTION_TYPE_QUOTATION_WINDOW_15M_REMINDER_SENT = "QUOTATION_WINDOW_15M_REMINDER_SENT"



# NEW AUTH_V2 Audit Actions
AUDIT_ACTION_TYPE_ACCOUNT_LOCKED = "ACCOUNT_LOCKED"
...
# Issuance LG Expiry Reminders (A1)
AUDIT_ACTION_TYPE_ISSUANCE_LG_EXPIRY_REMINDER_FIRST = "ISSUANCE_LG_EXPIRY_REMINDER_FIRST_SENT"
AUDIT_ACTION_TYPE_ISSUANCE_LG_EXPIRY_REMINDER_SECOND = "ISSUANCE_LG_EXPIRY_REMINDER_SECOND_SENT"
ACTION_TYPE_ISSUANCE_LG_EXPIRY_REMINDER = "ISSUANCE_LG_EXPIRY_REMINDER"

# LG Expired Communication (A2)
AUDIT_ACTION_TYPE_ISSUANCE_LG_EXPIRED_NOTIFICATION = "ISSUANCE_LG_EXPIRED_NOTIFICATION_SENT"

# Reference Expiry (A3)
AUDIT_ACTION_TYPE_REFERENCE_EXPIRY_REMINDER = "REFERENCE_EXPIRY_REMINDER_SENT"
AUDIT_ACTION_TYPE_LG_REFERENCE_VALIDITY_FLAGGED = "LG_REFERENCE_VALIDITY_FLAGGED"

# Facility Utilization Alerts (A7)
AUDIT_ACTION_TYPE_FACILITY_UTILIZATION_ALERT = "FACILITY_UTILIZATION_ALERT_SENT"
AUDIT_ACTION_TYPE_FACILITY_EXPIRY_ALERT = "FACILITY_EXPIRY_ALERT_SENT"

# Ownership change (A4)
ACTION_TYPE_ISSUANCE_LG_CHANGE_OWNERSHIP = "ISSUANCE_LG_CHANGE_OWNERSHIP"
